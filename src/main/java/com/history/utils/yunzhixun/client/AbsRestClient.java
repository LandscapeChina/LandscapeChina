...
import com.history.utils.yunzhixun.utils.SSLHttpClient;
...
public abstract class AbsRestClient {
	public boolean isTest=Boolean.parseBoolean(YunZhiXunPropertiesUtil.getProperty("is_test"));
	public String server= YunZhiXunPropertiesUtil.getProperty("rest_server");
	public String sslIP= YunZhiXunPropertiesUtil.getProperty("http_ssl_ip");
	public int sslPort=Integer.parseInt(YunZhiXunPropertiesUtil.getProperty("http_ssl_port"));
	public String version= YunZhiXunPropertiesUtil.getProperty("version");
